  ...
  <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
    <div class="max-w-md w-full p-6">
      ...
      <form action="#" method="POST" class="space-y-4">
        ...
        <div>
        <div class='flex flex-col items-center'><button type="button" class=" items-center text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Purple to Blue</button></div>
        </div>
      </form>
      <div class="mt-4 text-sm text-gray-600 text-center">
